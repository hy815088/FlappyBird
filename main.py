...
def welcomescreen():
    ...
    while True:
        ...
        background = 'gallery/sprites/background'+str(a)
        game_sprites['background'] = pygame.image.load(background).convert()
        b= random.randint(1,2)
        pipe = 'gallery/sprites/pipe'+str(b)
...
if __name__ == "__main__":
    ...
    game_sprites['numbers'] = (
        pygame.image.load('gallery/sprites/0').convert_alpha(),
        pygame.image.load('gallery/sprites/1').convert_alpha(),
        pygame.image.load('gallery/sprites/2').convert_alpha(),
        pygame.image.load('gallery/sprites/3').convert_alpha(),
        pygame.image.load('gallery/sprites/4').convert_alpha(),
        pygame.image.load('gallery/sprites/5').convert_alpha(),
        pygame.image.load('gallery/sprites/6').convert_alpha(),
        pygame.image.load('gallery/sprites/7').convert_alpha(),
        pygame.image.load('gallery/sprites/8').convert_alpha(),
        pygame.image.load('gallery/sprites/9').convert_alpha(),
    )

    game_sprites['message'] = pygame.image.load('gallery/sprites/message1').convert_alpha()
    game_sprites['base'] = pygame.image.load('gallery/sprites/base').convert_alpha()
    game_sprites['pipe'] = (pygame.transform.rotate(pygame.image.load(pipe).convert_alpha(),180),

                pygame.image.load(pipe).convert_alpha()
    )

    game_sounds['die'] = pygame.mixer.Sound('gallery/audio/die')
    game_sounds['hit'] = pygame.mixer.Sound('gallery/audio/hit')
    game_sounds['point'] = pygame.mixer.Sound('gallery/audio/point')
    game_sounds['swoosh'] = pygame.mixer.Sound('gallery/audio/swoosh')
    game_sounds['wing'] = pygame.mixer.Sound('gallery/audio/wing')

    game_sprites['background'] = pygame.image.load(background).convert()
    game_sprites['player'] = pygame.image.load(player).convert_alpha()
    game_sprites['game_over'] = pygame.image.load("gallery/sprites/gameover").convert_alpha()
    game_sprites['yourscore'] = pygame.image.load("gallery/sprites/yourscore").convert_alpha()
    game_sprites['highscore'] = pygame.image.load("gallery/sprites/highscore").convert_alpha()
